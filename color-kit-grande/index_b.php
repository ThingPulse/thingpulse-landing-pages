    ...
    <body>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                            ...
                            <p class="lead mb-0">Get ready for an electrifying project that combines soldering and programming! 
                                It's the perfect blend of hands-on skill and high-tech know-how. Dive in and unleash your creativity!</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                            <div class="features-icons-icon d-flex"><i class="bi-cloud-hail m-auto text-primary"></i></div>
                            <h3>Weather Display App</h3>
                            <p class="lead mb-0">We've prepared a beautiful weather display application for you to learn from and extend!</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-0 mb-lg-3">
                            ...
                            <p class="lead mb-0">The kit comes with a bright and clear display featuring a capacitive touch interface to respond to your commands!</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid bg-light p-0">
                <div class="row g-0">
                    ...
                    <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                        <h2>Perfect for Teaching & Learning STEM</h2>
                        <p class="lead mb-0">
                            ...
                            Contact us for educational discounts.
                        </p>
                        <div class="mt-3">
                            <a href="https://thingpulse.com/product/esp32-wifi-color-display-kit-grande/?utm_source=google&utm_medium=pmax&utm_campaign=ckg&utm_content=stem_cta" type="button" class="btn btn-primary btn-sm">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="row g-0">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                        ...
                        <div class="mt-3">
                            <a href="https://thingpulse.com/product/esp32-wifi-color-display-kit-grande/?utm_source=google&utm_medium=pmax&utm_campaign=ckg&utm_content=soldering_cta" type="button" class="btn btn-primary btn-sm">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="row g-0 bg-primary">
                    ...
                    <div class="col-lg-6 order-lg-2 my-auto showcase-text text-white text-center">
                        ...
                        <a href="https://thingpulse.com/cart/?multiple-item-to-cart=4354|6327&coupon=ckglipofree&utm_source=google&utm_medium=pmax&utm_campaign=ckg&utm_content=top_cta" class="btn btn-warning btn-lg active" role="button" aria-pressed="true">
        ...
        <section class="call-to-action text-white text-center" id="signup">
            <div class="container position-relative">
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <a href="https://thingpulse.com/cart/?add-to-cart=4354&utm_source=google&utm_medium=pmax&utm_campaign=ckg&utm_id=20693735939" class="btn btn-warning btn-lg active" role="button" aria-pressed="true">
                            Order Your Kit Now! USD39.90
                        </a>
                        <div class="text-left text-white font-alt mb-4">
                            Not Convinced? 
                            <a class="text-white-underline" href="https://thingpulse.com/product/esp32-wifi-color-display-kit-grande/?utm_source=google&utm_medium=pmax&utm_campaign=gateway&utm_content=top_cta">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
